...
module.exports = function(app){
    ...
    app.post('/wxnotify', function (req, res) {
        ...
        console.log(notify.responseObj)
        /*var verify = req.body.out_trade_no
         var f_obj = notify.findRespondObj(verify)
        notify.forNotify(f_obj, function(s_res){
            if(s_res != 'err for respond'){
