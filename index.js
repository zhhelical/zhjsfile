...
var zipFeedback = function(f_name, respond){
    var send_gzip = function(file, res, cb){
        var gzipstream = zlib.createGzip()
        var file = fs.createReadStream(path.resolve(file))
        var img_info = imginfo(fs.readFileSync(path.resolve(file)))
