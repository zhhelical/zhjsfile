...
wss_server.on('connection', function(conn){
    ...
    conn.on('error', function() {
        ...
        /*wss_server.removeListener('connection', function(res){
            //
        })*/
    })
    ...
    conn.on('removeListener', ('close', fn) => {
        console.log(`remove close ${fn.name} event`)
    })
    conn.on('removeListener', ('error', fn) => {
        console.log(`remove error ${fn.name} event`)
    })
})
