...
var reqMasterNets = function(mData, conn){
    var myHeaders = {"Content-Type":"text/plain", "Content-Length":content.length.toString(), "X-Custom-Header":"ProcessThisImmediately"}
    var myInit = {
        method: 'GET',
        headers: myHeaders,
        mode: 'cors',
    ...
    fetch(mData.value, myInit).then(function(res){
        sendEndDeal(mData.key, conn, res)
        return res
    }).catch(function(err) {
