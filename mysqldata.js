                ...
                if(err)
                    ...
                    conn.query("SELECT * FROM messages WHERE openid='" + openid + "'", function (err, results) {
                        ...
                        if(results.length) {
                            ...
                            var time = [[t_send]]
                            var ins_contents = contents.msg.replace(/\n/g, "\\\\n")
                                .replace(/'/g, "\\'")
                                .replace(/\r/g, "\\\\r")
                            contents.msg = ins_contents
                            console.log(contents)
                            var s_contents = JSON.stringify([[contents]])
                            var q_str = "INSERT INTO messages (openid, contents, time) VALUES(" + "'" + openid + "'" + ", " + "'" + s_contents + "'" + ", " + "'" + JSON.stringify(time) + "')"
                            console.log(q_str)
